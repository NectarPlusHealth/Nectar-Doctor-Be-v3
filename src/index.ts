...
const allowedOrigins = ['http://localhost:4200','https://nectarplus.health','http://localhost:4400','http://localhost:4500', 'http://82.112.237.181:4500','https://doctor.nectarplus.health'];
